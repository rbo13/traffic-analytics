...
import (
	...
	"github.com/whaangbuu/traffic-analytics/utils"
)

// We register the Pusher client
var client = pusher.Client{
	AppId:   utils.GetEnvWithDefault("PUSHER_APP_ID", ""),
	Key:     utils.GetEnvWithDefault("PUSHER_KEY", ""),
	Secret:  utils.GetEnvWithDefault("PUSHER_SECRET", ""),
	Cluster: utils.GetEnvWithDefault("PUSHER_CLUSTER", ""),
	Secure:  true,
}
